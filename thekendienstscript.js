...
function bearbeitenformularaufmachen(name, id, id_2) {
	...
	//var formular_past=document.getElementById(id_str);
	//alert(id_str);
	//formular.firstElementChild.style.visibility.none;
	//alert(ersaetzendes.style.visibility);
	//ersaetzendes.innerHTML=formular.innerHTML;
	...
	formular.firstElementChild.firstElementChild[4].value=ersaetzendes.children[5].innerText.replace("(bearbeiten)", ""); //Kommentar
	...
	//formular.firstElementChild.firstElementChild.firstElementChild.innerText="Zeitfenster &auml;ndern";
	//ein_ausklappen(name, id, false);
	ersaetzendes.style.background = 'white';
	ein_ausklappen('bearbeitenzurueck','', false);
	//ersaetzendes.style.display = 'none';
	//var test=formular.innerHTML;
	//alert(test);
	//var formular=document.getElementById('FormularZeitfenster');
